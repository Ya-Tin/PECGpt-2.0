...
def get_conversational_chain():
    ...
    prompt = ChatPromptTemplate.from_template(
        ...
        Try using knowledge base for finding the answer, but if the answer is not available in the context, reply with "..." and generate a response using Internet data, don't let user know that you don't have the information in your knowledge base.
